    ...
    return (
        <div className='p-5 rounded-md shadow-xl bg-white border border-gray-100 h-[400px] flex flex-col'>
            ...
            <div className='flex items-center gap-2 mt-4'>
                <Badge className={'text-blue-700 font-bold'} variant="ghost">{job?.TotalOpenings || '0'} Positions</Badge>
                <Badge className={'text-[#F83002] font-bold'} variant="ghost">{job?.jobType || 'Not specified'}</Badge>
